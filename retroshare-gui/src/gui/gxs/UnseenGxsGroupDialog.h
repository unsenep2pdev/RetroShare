...
//unseenp2p comment:
// we copy from the GxsGroupDialog and customise it to UnseenGxsGroupDialog
#ifndef _UNSEEN_GXS_GROUP_DIALOG_H
#define _UNSEEN_GXS_GROUP_DIALOG_H

#include "ui_UnseenGxsGroupDialog.h"
 ...
 */
class UnseenGxsGroupDialog : public QDialog, public TokenResponse
{
	Q_OBJECT
...
public:
	 ...
	 * @param mode
	 */
    UnseenGxsGroupDialog(TokenQueue* tokenQueue, uint32_t enableFlags, uint32_t defaultFlags, QWidget *parent = NULL);
